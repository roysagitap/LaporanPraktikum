...
public class Main{
  public static void main(String[] args) {
    ...
    teknologi.add(new Buku("Cara menjadi hengker", Arrays.asList("Ahmad", "Nurul"), "Mempelajari teknologi keamanan dan etika untuk menjadi hacker yang sukses."));
    teknologi.add(new Buku("Build pc dalam 5 menit", Arrays.asList("Adinda"), "bagaimana caranya agar build pc menjadi hal menyenangkan dalam waktu singkat"));
    ...
    for(Buku buku : teknologi){
      ...
      System.out.println("+ Banyak kata di sinopsis :" + buku.countWords(buku.getSinopsis()));
      System.out.println("");
    }
    ...
    //copy
    String search = "Cara menjadi hengker";
    Boolean check = false;
    Buku copyBuku = null;
    for(Buku buku : teknologi){
      if(buku.getJudul().equals(search)){
        copyBuku = buku.copy();
        check = true;
      }
    }
    if(check){
      System.out.println("- " + copyBuku.getJudul() + " " + copyBuku.getPenulis());
      System.out.println("  Sinopsis : " + copyBuku.getSinopsis());
      System.out.println("+ Banyak kata di sinopsis :" + copyBuku.countWords(copyBuku.getSinopsis()));
      System.out.println("");
    }
